...
export default function Pendingsubmit({ispending,isOK,setIsUiShow}:PendingProps){
    return(
      ...
      <div className="w-full max-w-md rounded-lg space-y-6 bg-white p-6 shadow-xl dark:bg-gray-800 justify-center text-center text-[20px] font-bold">
       ...
       {isOK&& !ispending &&(
        <p className="text-[14px]">Successful Saving</p>
       )}
       {!isOK && !ispending&&(
        <p className="text-[14px]">Failed to Save. Please Try again</p>
       )}
